            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="ajax/loginProses.php">
                  ...
                  <div class="text-center">
                    ...
                    <a class="small" href="http://localhost/project-akhir-gis/app/register.php">Create an Account!</a>
                  </div>
                  <br><br><br><br>
                </div>
              </div>
